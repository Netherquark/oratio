...
class Translator:
    ...
    def __init__(
        ...
        #########################################
        self.cfg.task.max_source_positions = 4096
        self.cfg.task.max_target_positions = 4096
        self.cfg.generation.max_len_b = 4096
        self.cfg.generation.max_len_b_mt = 4096
        self.cfg.generation.beam = 3
        #########################################
